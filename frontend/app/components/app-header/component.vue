<template>
	<header
		...
		<div class="flex items-center justify-between w-full px-6 h-16 max-w-[1280px] mx-auto">
			<!-- Brand -->
			<a class="text-xl font-extrabold tracking-tighter text-slate-900 dark:text-white" href="#">
				LuxCommerce
			</a>
			...
			<nav class="hidden md:flex items-center gap-6 font-['Manrope'] text-sm font-medium">
				<a class="text-slate-900 dark:text-white border-b-2 border-slate-900 dark:border-slate-100 pb-1 hover:text-slate-900 dark:hover:text-white transition-colors active:scale-95 transition-transform"
					href="#">Shop</a>
				<a class="text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white transition-colors active:scale-95 transition-transform"
					href="#">Categories</a>
				<a class="text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white transition-colors active:scale-95 transition-transform"
					href="#">Deals</a>
				<a class="text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white transition-colors active:scale-95 transition-transform"
					href="#">Merchant Portal</a>
			</nav>
